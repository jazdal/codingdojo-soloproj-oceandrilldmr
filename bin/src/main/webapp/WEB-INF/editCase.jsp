...
<head>
	...
	<title>OceanDrill DMR: Edit Case</title>
...
<body>
	...
	<div id="regForm" class="p-3 container">
		...
		<h3 class="text-center fw-bold">EDIT CASE</h3>
		<h3 class="mb-5 text-center fw-bold">FOR ${currentCase.patient.firstName.toUpperCase()} ${currentCase.patient.lastName.toUpperCase()}</h3>
		<div class="row justify-content-center">
			<form:form class="p-2 col-md-10 card bg-success-subtle bg-gradient shadow" action="/cases/edit/${thisCase.id}" method="PUT" modelAttribute="thisCase">
				...
				<div class="card-body">
					<div class="row mb-4 align-items-center justify-content-between">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control fs-5" placeholder="${currentCase.patient.firstName} ${currentCase.patient.middleName.substring(0,1)}. ${currentCase.patient.lastName}, ${thisCase.patient.company}" disabled/>
						</div>
					</div>
					<div class="row mb-4 align-items-center justify-content-between">
						<div class="col-auto">
					...
					<div class="row justify-content-center">
						<input type="submit" class="btn btn-success bg-gradient shadow fs-5 fw-semibold" value="Update Case">
					</div>
				</div>
			</form:form>
		</div>
