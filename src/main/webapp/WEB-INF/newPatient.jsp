...
<head>
	...
	<title>OceanDrill DMR: Add Patient</title>
...
<body>
	...
	<div id="regForm" class="p-3 container">
		...
		<h2 class="mb-5 text-center fw-bold">CREATE NEW PATIENT</h2>
		<div class="row justify-content-center">
			<form:form class="p-2 col-md-10 card bg-success-subtle bg-gradient shadow" action="/patients/new" method="POST" modelAttribute="patient">
				...
				<div class="card-body">
					...
					<div class="d-flex justify-content-center">
						<input type="submit" class="btn btn-success bg-gradient fs-5 fw-semibold shadow" value="Add Patient">
					</div>
				</div>
			</form:form>
		</div>
